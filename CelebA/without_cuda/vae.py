...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(32, 32, kernel_size=5, stride=2, padding=0)
        self.bn2 = nn.BatchNorm2d(32)
        self.conv3 = nn.Conv2d(32, 64, kernel_size=4, stride=2, padding=0)
        self.bn3 = nn.BatchNorm2d(64)
        self.conv4 = nn.Conv2d(64, 64, kernel_size=4, stride=2, padding=0)
    ...
    def decode(self, z):
        ...
        h11 = F.elu(self.deconv4(h10))
        #h12 = self.deconv5(h12)
        return h11
